    ...
    <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-3">
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-primary-foreground/70">
          ...
          <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-gold" /> +251913827932</li>
          <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-gold" /> seyoumshega@gmail.com</li>
        </ul>
      </div>
    </div>
